...
import ViceChancellorLogin from "./components/ViceChancellor/ViceChancellorLogin";
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
          ...
          <Link to={`/vice-chancellor-login`} style={{ color: "inherit", textDecoration: "inherit" }} >
            <ListItem button selected={location.pathname == `/vice-chancellor-login`}>
              <ListItemIcon>
                <LoginIcon />
              </ListItemIcon>
              <ListItemText primaryTypographyProps={{ fontSize: '19px' }}>
      ...
      <Main open={open}>
        ...
        <Box sx={{ p: 2 }}>
          <Routes>
            ...
            <Route path="/vice-chancellor-login" element={<ViceChancellorLogin />} />
