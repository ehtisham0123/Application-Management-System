     ...
     <Box sx={{ display: "flex", justifyContent: "space-between", mb: 3 }}>
      ...
      <form onSubmit={handleSubmit} className="needs-validation">
        ...
        <div className="row">
          ...
          <div className="form-group col-md-6">
            <label for="discipline">Teachers Role</label>
            <select
              id="role"
              name="role"
            ...
            >
              ...
              <option value="Coordinator Software Engineering">Coordinator Software Engineering</option>
              <option value="Coordinator Computer Science">Coordinator Computer Science</option>
              <option value="Coordinator M. Phil.">Coordinator M. Phil.</option>
