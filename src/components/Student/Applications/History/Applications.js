...
function Appliciations() {
  ...
  const deleteApplication = async (id) => {
    await axios
      .delete(`http://localhost:5000/student/applications/${id}`, {
        headers: {
          token: token,
        },
      })
  ...
  const columns = [
    ...
    { field: "details", headerName: "Assignment Details", width: 400 },
    {
      field: "status",
      headerName: "Status",
      sortable: false,
