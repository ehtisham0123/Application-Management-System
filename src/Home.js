...
function Home() {
  return (
    <div id="content" className="px-4 px-md-5" >
	<br />
<br />
      <h2 className="text-center ">Application Process System.</h2>
       <div className="row d-flex align-items-center">
        <div className="col-md-6">

      <h5 style={{lineHeight:"30px"}}>
	The "Application Process System" is a transformative project designed to address the challenges faced by university students when submitting applications to the Computer Science Department.
	
      </h5> 
      <br/>
      <h5 style={{lineHeight:"30px"}}>
 This system aims to streamline and modernize the application process by replacing manual paperwork with a user-friendly online platform.         
 </h5>  

        </div>
        <div className="col-md-6 mb-5">
             
        <svg width="64" height="64" className="svg" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="study">
